...
import { ITV, MediaContext } from "../../MediaContext";
...
export default function TvShows() {
  ...
  async function getTrending(pageNumber: number) {
    const { data } = await axios.get(`https://api.themoviedb.org/3/trending/tv/day?api_key=90142caa6b0287afefb2bd4ad6d11624&page=${pageNumber}`);
